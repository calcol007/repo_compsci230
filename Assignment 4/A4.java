...
public class A4 extends JFrame {
	...
	* @return toolsPanel the Panel */
	...
	public class AddActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (selectedNode instanceof NestedShape) {
				...
				JOptionPane.showMessageDialog(A4.this, "ERROR: No node selected.");
			} else {
				JOptionPane.showMessageDialog(A4.this, "ERROR: Must select a NestedShape node.");
			}
		} 
	}
	...
	public class RemoveActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			Object selectedNode = tree.getLastSelectedPathComponent();
			if (selectedNode != panel.getRoot() && selectedNode != null) {
				panel.removeShapeNode((Shape)selectedNode);
			} else if (selectedNode == null) {
				JOptionPane.showMessageDialog(A4.this, "ERROR: No node selected.");
			} else {
				JOptionPane.showMessageDialog(A4.this, "ERROR: Must not remove the root.");
			}
		} 
	}
